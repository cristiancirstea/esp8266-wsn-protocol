...
struct WSNWiFiConfig{
  ...
  WiFiCredentials credentials[WIFI_CREDENTIALS_MAX_COUNT] =
  {
    WiFiCredentials(
      "curcubeul mic",
      "popcorn4321",
      IPAddress(192,168,43,NODE_SUBNET_SUFFIX), //Static IP
      IPAddress(192,168,43,1),   //Gateway
      IPAddress(255,255,255,0),  //Mask
      IPAddress(192,168,43,255)  //Broadcast
    ),
    WiFiCredentials(
      "ESP8266-head-node~",
      "test12345678",
    ...
    WiFiCredentials(
      "Camera Curcubeului", //SSID
      "corpor@rist",  //Password
      IPAddress(192,168,44,NODE_SUBNET_SUFFIX), //Static IP
      IPAddress(192,168,44,1),   //Gateway
      IPAddress(255,255,255,0),  //Mask
      IPAddress(192,168,44,255)  //Broadcast
    ),
    WiFiCredentials(
      "lenny", //SSID
      "popcorn4321",  //Password
      IPAddress(192,168,137,NODE_SUBNET_SUFFIX), //Static IP
      IPAddress(192,168,137,1),   //Gateway
      IPAddress(255,255,255,0),  //Mask
      IPAddress(192,168,137,255)  //Broadcast
    )
  };
